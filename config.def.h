...
static const char *termone[]  = { "st", NULL };
...
static const char *playpp[]   = { "playerctl", "play"      , NULL };
static const char *playps[]   = { "playerctl", "pause" 		 , NULL };
...
static Key keys[] = {
  ...
  { 0, 														 XF86XK_AudioPause,       spawn, {.v = playps}},
